# Andre Oort Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/andre-oort-conjecture-canonical-lane-mathlib.git
cd andre-oort-conjecture-canonical-lane-mathlib
lake exe
lake build
```
